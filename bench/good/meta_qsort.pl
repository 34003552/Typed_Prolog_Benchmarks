...
:- type empty.
:- type unk_t0 --->
	'true' ; 'fail' ; 'qsort' ; '!' ; integer =< integer ; (unk_t0 -> unk_t0) ; \+(unk_t0) ; (unk_t0, unk_t0) ;
	partition(list(integer), integer, list(integer), list(integer)) ; qsort(list(integer), list(integer), list(integer)) ;
	'unk_t0'(unk_t0) ; 'unk_t0'((unk_t0 ; unk_t0)).

:- trust_pred number(unk_t0).
:- trust_pred nonvar(unk_t0).
...
:- pred interpret_disjunction(unk_t0, unk_t0, unk_t0).
...
:- pred is_built_in(unk_t0).
is_built_in(true).
is_built_in(_=<_).

:- pred interpret_built_in(unk_t0).
interpret_built_in(true).
interpret_built_in(X=<Y) :- X =< Y.


:- pred define(unk_t0, unk_t0).
